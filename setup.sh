...
# Step 5: Create the MyGPT folder
...
# Step 7: Download the source code for mygpt.py from GitHub
...
# Step 8: Get the absolute path of the Python script
PYTHON_PATH="$HOME/MyGPT/.venv/bin/python $HOME/MyGPT/mygpt.py"

# Step 9: Add alias to bashrc for easy access
...
# Step 10: Go back to home directory and run mygpt
